        ...
        <AdminLayout>
            ...
            <div className="mb-6">
                ...
                <p className="text-zinc-600 dark:text-zinc-400">
                    Update your personal details displayed on your website.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            This information appears on all pages
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-4">
                                ...
                                <div>
                                    <Label htmlFor="contact_description">
                                        Contact Description
                                    </Label>
                                    <Textarea
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Upload your CV for the About page
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleCvUpload} className="space-y-6">
                            <div>
                                <Label htmlFor="cv_file">
                                    CV File (PDF recommended)
                                </Label>
                                <Input
                                    id="cv_file"
                                    type="file"
                                    onChange={(e) =>
                                        setCvData("cv_file", e.target.files[0])
                                    }
                                    className="mt-1"
                                />
                                {errors.cv_file && (
                            ...
                            <button
                                type="submit"
                                disabled={!cvData.cv_file || processing}
                                className="inline-flex items-center justify-center bg-black text-white py-2 px-4 rounded-md hover:bg-zinc-800 transition-colors"
                            >
                                Upload CV
                            </button>
